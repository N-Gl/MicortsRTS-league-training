...
Diese implementation benutzen wir in abgeänderter Form in LT und wurde auch zuvor für den Basis-Agenten verwendet. 
Unteranderem wurde \emph{invalid action masking} und geeignete Aktions-/Beobachtungsrepräsentationen (z.\,B. GridNet), sowie architektonische Entscheidungen (u.\,a. IMPALA-CNN \cite{espeholt2018impala}) angewandt, die auch in dem LT Code noch benutzt werden \cite{huang2021gym}.
% hier weiter machen
\vspace{10pt}
