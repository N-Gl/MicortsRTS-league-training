...
\begin{frame}{Observation Adjustment for SP}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=\linewidth,height=0.60\textheight,keepaspectratio]{adjust_obs_präsentation.pdf}
    \end{center}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.60\textwidth}
            ...
            \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}l c c c@{}}
                ...
                \midrule
                WorkerRushAI (FT) & \BestWinRateCell{100.0} & \WinRateCell{35.0} & \WinRateCell{99.5} \\
                ...
                Tiamat & \WinRateCell{93.0} & \WinRateCell{99.0} & \BestWinRateCell{99.0} \\
        ...
        \begin{column}{0.36\textwidth}
            \small
            \begin{itemize}
                \item training bots: CoacAI and Mayari in LT, WorkerRushAI in FT
                \item RBAI: better against drawing bots
                \item WRAI: clear LT weakness, then FT training opponent
                \item LT gains stay after FT
                \item all MCTS win rates improve after FT
                % TODO: \item without new initial agents overall win rate: \textbf{74.1\%} 
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Interpretation of the Results}
    ...
    \begin{itemize}
        ...
        % TODO: \item exploiter diversity determines which weaknesses LT can discover
...
% TODO: \begin{frame}[noframenumbering]{Detailed Evaluation Results: Win Rates}
% TODO:     \centering
% TODO:     \scriptsize
% TODO:     \setlength{\tabcolsep}{3pt}
% TODO:     \renewcommand{\arraystretch}{1.02}
% TODO:     \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}l c c c c@{}}
% TODO:         \toprule
% TODO:         Opponent & \shortstack{Main Agent\\without new initial agents} & Base Agent & Main Agent (LT) & \shortstack{Main Agent +\\Fine-tuning} \\
% TODO:         \midrule
% TODO:         \multicolumn{5}{l}{\textit{bots used in training}} \\
% TODO:         CoacAI & \BestWinRateCell{100.0} & \WinRateCell{96.0} & \BestWinRateCell{100.0} & \BestWinRateCell{100.0} \\
% TODO:         Mayari & \BestWinRateCell{100.0} & \WinRateCell{67.3} & \BestWinRateCell{100.0} & \BestWinRateCell{100.0} \\
% TODO:         \midrule
% TODO:         \multicolumn{5}{l}{\textit{scripted bots}} \\
% TODO:         WorkerRushAI & \WinRateCell{31.0} & \BestWinRateCell{100.0} & \WinRateCell{35.0} & \WinRateCell{99.5} \\
% TODO:         PassiveAI & \BestWinRateCell{100.0} & \WinRateCell{99.7} & \BestWinRateCell{100.0} & \BestWinRateCell{100.0} \\
% TODO:         LightRushAI & \BestWinRateCell{100.0} & \WinRateCell{98.0} & \BestWinRateCell{100.0} & \BestWinRateCell{100.0} \\
% TODO:         RandomAI & \BestWinRateCell{100.0} & \WinRateCell{99.0} & \BestWinRateCell{100.0} & \BestWinRateCell{100.0} \\
% TODO:         RandomBiasedAI & \WinRateCell{91.0} & \WinRateCell{79.0} & \WinRateCell{97.0} & \BestWinRateCell{97.5} \\
% TODO:         \midrule
% TODO:         \multicolumn{5}{l}{\textit{MCTS based bots}} \\
% TODO:         Rojo & \BestWinRateCell{100.0} & \WinRateCell{81.0} & \BestWinRateCell{100.0} & \BestWinRateCell{100.0} \\
% TODO:         MixedBot & \WinRateCell{45.0} & \WinRateCell{43.3} & \WinRateCell{57.0} & \BestWinRateCell{60.5} \\
% TODO:         Izanagi & \WinRateCell{68.0} & \WinRateCell{71.7} & \WinRateCell{70.0} & \BestWinRateCell{72.5} \\
% TODO:         Tiamat & \WinRateCell{94.0} & \WinRateCell{93.0} & \BestWinRateCell{99.0} & \BestWinRateCell{99.0} \\
% TODO:         Droplet & \WinRateCell{45.0} & \WinRateCell{67.7} & \WinRateCell{62.0} & \BestWinRateCell{75.5} \\
% TODO:         GuidedRojoA3N & \WinRateCell{64.0} & \WinRateCell{74.7} & \WinRateCell{87.0} & \BestWinRateCell{88.5} \\
% TODO:         NaiveMCTS & \WinRateCell{0.0} & \WinRateCell{0.7} & \WinRateCell{2.0} & \BestWinRateCell{6.5} \\
% TODO:         \midrule
% TODO:         overall & \WinRateCell{74.1} & \WinRateCell{76.5} & \WinRateCell{79.2} & \BestWinRateCell{85.7} \\
% TODO:         \bottomrule
% TODO:     \end{tabular*}
% TODO: \end{frame}
% TODO: 
% TODO: \begin{frame}[noframenumbering]{Detailed Evaluation Results: Loss Rates}
% TODO:     \centering
% TODO:     \scriptsize
% TODO:     \setlength{\tabcolsep}{3pt}
% TODO:     \renewcommand{\arraystretch}{1.02}
...
% TODO:         \midrule
% TODO:         \multicolumn{5}{l}{\textit{bots used in training}} \\
% TODO:         CoacAI & \BestLossRateCell{0.0} & \LossRateCell{2.0} & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} \\
% TODO:         Mayari & \BestLossRateCell{0.0} & \LossRateCell{27.3} & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} \\
% TODO:         \midrule
% TODO:         \multicolumn{5}{l}{\textit{scripted bots}} \\
% TODO:         WorkerRushAI & \LossRateCell{63.0} & \BestLossRateCell{0.0} & \LossRateCell{55.0} & \LossRateCell{0.5} \\
% TODO:         PassiveAI & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} \\
% TODO:         LightRushAI & \BestLossRateCell{0.0} & \LossRateCell{2.0} & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} \\
% TODO:         RandomAI & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} \\
% TODO:         RandomBiasedAI & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} \\
% TODO:         \midrule
% TODO:         \multicolumn{5}{l}{\textit{MCTS based bots}} \\
% TODO:         Rojo & \BestLossRateCell{0.0} & \LossRateCell{5.3} & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} \\
% TODO:         MixedBot & \LossRateCell{33.0} & \LossRateCell{34.3} & \LossRateCell{20.0} & \BestLossRateCell{13.5} \\
% TODO:         Izanagi & \LossRateCell{15.0} & \LossRateCell{16.3} & \LossRateCell{7.0} & \BestLossRateCell{6.0} \\
% TODO:         Tiamat & \LossRateCell{6.0} & \LossRateCell{7.0} & \LossRateCell{1.0} & \BestLossRateCell{0.5} \\
% TODO:         Droplet & \LossRateCell{22.0} & \BestLossRateCell{9.0} & \LossRateCell{22.0} & \LossRateCell{10.5} \\
% TODO:         GuidedRojoA3N & \BestLossRateCell{0.0} & \LossRateCell{1.7} & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} \\
% TODO:         NaiveMCTS & \BestLossRateCell{0.0} & \LossRateCell{2.7} & \BestLossRateCell{0.0} & \BestLossRateCell{0.0} \\
% TODO:         \midrule
% TODO:         overall & \LossRateCell{9.9} & \LossRateCell{7.7} & \LossRateCell{7.5} & \BestLossRateCell{2.2} \\
% TODO:         \bottomrule
% TODO:     \end{tabular*}
% TODO: \end{frame}
% TODO: 
% TODO: \begin{frame}[noframenumbering]{Main Agent vs League Exploiter}
% TODO:     \begin{itemize}
% TODO:         \item the League Exploiter resets
% TODO:         \item different hyperparameters
% TODO:         \item historical League Exploiters are not included as Main Exploiter opponents
% TODO:     \end{itemize}
% TODO: \end{frame}
