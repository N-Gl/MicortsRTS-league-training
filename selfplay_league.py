...
class LeagueTrainer:
    ...
    def _get_main_ent_coef(self) -> float:
        ...
        completed_steps = global_step - batch_size
        frac = 1.0 - (completed_steps / total_timesteps)
    ...
    def train(self):
        ...
        if args.main_exploiters_paths is not None and len(args.main_exploiters_paths) > 0:
            ...
            for ag in self.active_league_agents:
                if isinstance(ag, league.MainExploiter) and ag.current_model is None:
        ...
        # =========================
            ...
            main_ent_coef = self._get_main_ent_coef()
