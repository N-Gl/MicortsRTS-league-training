...
Simmilar to AlphaStar our agent was further trained in a league of different agent types (Main Agent, Main Exploiters, League Exploiters, and historical snapshots (\emph{historical agents})) to reduce overfitting and forgetting and to promote diversity. 
