...
We hypothesize that this was not as big of a problem in AlphaStar, because the initial agent was trained with imitation learning on human data, which likely covered a much wider range of strategies, causing the inital agent to be more diverse than our Base Agent used in this thesis, which was trained with BC and PPO against only two built-in bots.
