...
The Annealed Entropy Coefficient decreases the weighting of the entropy bonus in the loss function and thereby decreases the exploration of the agent over the course of training.
...
This coefficient resets, when the Exploiter corresponding to it resets.
In the case of a League Exploiter, it is possible that the exploiter checkpoints but does not reset.
If that happens, Annealed Entropy Coefficient restarts at half of the last initial Annealed Entropy Coefficient.
