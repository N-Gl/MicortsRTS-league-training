...
In addition, a scalar feature vector is extracted from the observation to capture global game statistics, similar to the scalar features used in~\cite{vinyals2019alphastar}. This scalar vector contains 11 features:
\begin{itemize}
