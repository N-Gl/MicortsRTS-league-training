...
\begin{table*}[t]
\centering
\caption{Hyperparameters used for the League Training setups (1/3)}
...
\begin{table*}[t]
\centering
\caption{Hyperparameters used for the League Training setups (2/3)}
\scriptsize
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.05}
\begin{tabularx}{\textwidth}{@{}L{0.14\textwidth}L{0.34\textwidth}L{0.14\textwidth}Y@{}}
...
\midrule
\multicolumn{4}{@{}l}{\textbf{PPO Hyperparameters (Exploiters)}} \\
\midrule
...
\midrule
Self-Play & \texttt{selfplay\_ready\_save\_interval} & $5 \cdot 10^5$ & Step interval for potential league checkpoints. (checkpoint if the win rate is sufficiently high)\\
Self-Play & \texttt{main\_selfplay\_save\_interval} & $6 \cdot 10^6$ & Step interval for forced Main-Agent checkpoints. \\
Self-Play & \texttt{main\_exploiter\_selfplay\_save\_interval} & $9 \cdot 10^6$ & Step interval for forced Main-Exploiter checkpoints. \\
Self-Play & \texttt{league\_exploiter\_selfplay\_save\_interval} & $9 \cdot 10^6$ & Step interval for forced League-Exploiter checkpoints. \\
Self-Play & \texttt{main\_winrate\_threshold} & 0{,}7 & win rate threshold for Main Agent checkpoints. \\
Self-Play & \texttt{main\_exploiter\_winrate\_threshold} & 0{,}7 & win rate threshold for Main Exploiter checkpoints. \\
Self-Play & \texttt{league\_exploiter\_winrate\_threshold} & 0{,}7 & win rate threshold for League Exploiter checkpoints. \\
Self-Play & \texttt{main\_exploiter\_vs\_main\_winrate\_threshold} & 0{,}3 & Threshold for Main Exploiters against the Main Agent. \\
...
PFSP & \texttt{main\_pfsp\_weighting} & \texttt{focused\_strong\_with\_draws} & PFSP Weighting scheme for the Main Agent. \\
PFSP & \texttt{main\_exploiter\_pfsp\_weighting} & \texttt{focused\_strong\_boosted\_with\_draws} & PFSP Weighting scheme for Main Exploiters. \\
PFSP & \texttt{league\_exploiter\_pfsp\_weighting} & \texttt{focused\_strong\_boosted\_with\_draws} & PFSP Weighting scheme for League Exploiters. \\
\midrule
